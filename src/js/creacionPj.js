...
import {find, update, finddnd5eapi, urlRazas, urlRaza, urlClases, urlClase, urlArmaduras, urlArma, urlHabilidad, urlTipoAccesorios} from "./api.js";
...
// Evento de seleccion de habilidades
document.addEventListener("click", async function(event){
...
// Evento de Selección de Accesorio
document.addEventListener("click", async function(event){
...
// Evento de seleccion de Accesorio para guardar dato seleccionado
document.addEventListener("change", async function(event){
